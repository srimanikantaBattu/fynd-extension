                  ...
                  <div key={i} className="space-y-6">
                      ...
                      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-4 px-2">
                         <div className="flex items-center gap-5">
                             <div className="h-20 w-20 bg-slate-100 rounded-2xl animate-pulse"></div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                          {[1,2,3,4].map(j => (
                              <div key={j} className="h-full bg-white rounded-xl border border-slate-100 p-6 space-y-6 relative overflow-hidden">
                                  {/* Shimmer Effect */}
                                  ...
                                  {/* Button */}
                                  <div className="h-10 w-full bg-slate-100 rounded-lg animate-pulse mt-auto"></div>
                              </div>
                          ))}
                      </div>
                  </div>
